...
public class PopGenerator {	
	...
	/**
	 * This function finds the average activity duration for each activity inside a population file
	 * @param population
	 * @return
	 */
	 ...
	 */
	public static void splitActivity(Population population,Config config, String activityType,Double timeGapInSecond) {
	...
	public static void main(String[] args) {
		...
		splitActivity(population, config, "Usual place of work", 60*30.);
