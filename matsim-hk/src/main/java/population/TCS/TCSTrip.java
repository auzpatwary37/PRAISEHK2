...
public class TCSTrip {
	...
	private static final double maxTripExpansionFactor = 500; //At most 500 vehicles for the same person to avoid overload.
	...
	private double TCStimeConverter(Double time) {
		return 3600 * (time.intValue()/100) + 60 * (time.intValue() % 100);
	}
	
	public TCSTrip(double qNo,double memNo,double tripNo,double originActivity,double destinationActivity,
			TPUSB otpusb,TPUSB dtpusb,double departureTimeInput,double arrivalTimeInput,double tripPurpose,double modeHier,double timePeriod,
		...
		this.otpusb=otpusb;
		this.dtpusb=dtpusb;
		this.departureTime=this.TCStimeConverter(departureTimeInput);
		this.arrivalTime=this.TCStimeConverter(arrivalTimeInput);
		if(this.arrivalTime < 3 * 3600) { //Add 24 hours for the time.
			this.arrivalTime += 24 * 3600;
			this.departureTime += 24 * 3600;
		}
		
		this.tripPurpose=tripPurpose;
		this.modeHier=modeHier;
		this.timePeriod=timePeriod;
		this.tripExpansionFactor= maxTripExpansionFactor<expansionFactor? maxTripExpansionFactor:expansionFactor;
	}
...
//	}
	...
	/**
	 * Get the X coordinate of the origin TPUSB centroid
	 * @return coordinate in Saturn coordinate
	 */
	public double getOriginX() {
		return otpusb.getSatCoord().getX();
	}
	
	/**
	 * Get the Y coordinate of the origin TPUSB centroid
	 * @return coordinate in Saturn coordinate
	 */
	public double getOriginY() {
		return otpusb.getSatCoord().getY();
	}
	
	/**
	 * Get the X coordinate of the destination TPUSB centroid
	 * @return coordinate in Saturn coordinate
	 */
	public double getDestinationX() {
		return dtpusb.getSatCoord().getX();
	}
	
	/**
	 * Get the Y coordinate of the desination TPUSB centroid
	 * @return coordinate in Saturn coordinate
	 */
	public double getDestinationY() {
		return dtpusb.getSatCoord().getY();
	}
	...
	/**
	 * A convenient function to determine what tunnel it used
	 */
...
class TaxiTripLeg extends TripLeg{
	...
	public Double getTunnelUsed() {
		if(this.getTollRoadUsed().size()>1) {
			System.out.print("");
		}
