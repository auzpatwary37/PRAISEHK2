...
public class LinkGraph {
	 ...
	 * @return
	 */
	private double disutilityBetweenBusStopsOfLink(DataStopBus fromStop, Link fromLink, DataStopBus toStop, Link toLink) {
	 ...
	 */
	public void addBusStop(DataStopBus prevStop, DataStopBus currStop) {
		Set<Id<Link>> currLinks = currStop.getPossibleLinks();
