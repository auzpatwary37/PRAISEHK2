...
public abstract class TripChain{
	...
	private PopulationFactory popfac= PopulationUtils.getFactory(); //I modified there. Enoch //ScenarioUtils.createScenario(ConfigUtils.createConfig()).getPopulation().getFactory();
